...
import { studentFAQData } from '../../data/studentFAQData'
import { FeatherIcon } from '../../utils/icons/fontawesome'

const StudentFAQInit = (): React.ReactNode => {
  const [searchText, setSearchText] = useState('')
  const [expandedId, setExpandedId] = useState<string | null>(null)

  const filteredFAQs = studentFAQData.filter(
    item =>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TextInput
          ...
          placeholder="Search student FAQs..."
...
export const StudentFAQ = memo(StudentFAQInit)
